        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                function(position) {
                    ...
                    <!-- 3 蕗谷虹児記念館 -->
                    <a-entity
                        gltf-model="./assets/hukiyakouji.glb"
                        rotation="0 0 0"
                        scale="0.5 0.5 0.5"
                        animation="property: rotation; to: 0 360 0; loop: true; dur: 15000; easing: linear;"
                    ...
                    <!-- 7 和泉屋 -->
                    <a-entity
                        gltf-model="./assets/mitarashi.glb"
                        rotation="0 0 0"
                        scale="2 2 2"
                        animation="property: rotation; to: 0 360 0; loop: true; dur: 15000; easing: linear;"
                    ...
                    <!-- 8 珈琲 詩織 -->
                    <a-entity
                        gltf-model="./assets/melonsoda.glb"
                        rotation="0 0 0"
                        scale="1 1 1"
                        animation="property: rotation; to: 0 360 0; loop: true; dur: 15000; easing: linear;"
                    ...
                    <!-- 10 翁屋 -->
                    <a-entity
                        gltf-model="./assets/kinunoyuugetsu.glb"
                        rotation="0 0 0"
                        scale="2 2 2"
                        animation="property: rotation; to: 0 360 0; loop: true; dur: 15000; easing: linear;"
                    ...
                    <!-- 12 COCOLATTE Café -->
                    <a-entity
                        gltf-model="./assets/cafelatte.glb"
                        rotation="0 0 0"
                        scale="1 1 1"
                        animation="property: rotation; to: 0 360 0; loop: true; dur: 15000; easing: linear;"
                    ...
                    <!-- 13 煉瓦屋 -->
                    <a-entity
                        gltf-model="./assets/kurimusoda.glb"
                        rotation="0 0 0"
                        scale="1 1 1"
                        animation="property: rotation; to: 0 360 0; loop: true; dur: 15000; easing: linear;"
                    ...
                    <!-- 15 運動場 テニスラケット -->
                    <a-entity
                        gltf-model="./assets/tenisuraketto.glb"
                        rotation="30 0 0"
                        scale="2 2 2"
                    ...
                    <!-- 16 運動場 テニスボール -->
                    <a-entity
                        gltf-model="./assets/tenisuboru.glb"
                        rotation="0 0 0"
                        scale="1 1 1"
                        animation="property: rotation; to: 0 360 0; loop: true; dur: 15000; easing: linear;"
                        gps-entity-place="latitude: 37.93674483232794; longitude: 139.3557529684019">
                    ...
                    <!-- 17 運動場 野球ボール -->
                    <a-entity
                        gltf-model="./assets/yakyuuboru.glb"
                        rotation="0 0 90"
                        scale="1 1 1"
                    ...
                    <!-- 18 運動場 野球バット -->
                    <a-entity
                        gltf-model="./assets/yakyuubatto.glb"
                        rotation="30 0 0"
                        scale="0.5 0.5 0.5"
                        animation="property: rotation; to: 30 360 0; loop: true; dur: 15000; easing: linear;"
                        gps-entity-place="latitude: 37.93674483232794; longitude: 139.3557529684019">
                    ...
                    <!-- 19 運動場 バレーボール -->
                    <a-entity
                        gltf-model="./assets/bareboru.glb"
                        rotation="0 0 0"
                        scale="1.5 1.5 1.5"
                    ...
                    <!-- 21 月岡 -->
                    <a-entity
                        gltf-model="./assets/tsukiokamanju.glb"
                        rotation="0 0 0"
                        scale="2 2 2"
                        animation="property: rotation; to: 0 360 0; loop: true; dur: 15000; easing: linear;"
                        gps-entity-place="latitude: 37.88106458170879; longitude: 139.31095811420894">
                    ...
                    <!-- 22 カトリック教会 -->
                    <a-entity gltf-model="./assets/katoriku.glb"
                        rotation="0 0 0"
                        scale="0.3 0.3 0.3"
                        animation="property: rotation; to: 0 360 0; loop: true; dur: 15000; easing: linear;"
                    ...
                    <!-- 23 足軽長屋 -->
                    <a-entity
                        gltf-model="./assets/ashigaru.glb"
                        rotation="0 0 0"
                        scale="0.2 0.2 0.2"
